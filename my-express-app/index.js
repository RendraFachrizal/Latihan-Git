...
app.get('/api/movies', loggerMiddleware, tokenMiddleware, yearMiddleware, getMovieApi)
app.get('/api/movies/:id',loggerMiddleware, checkIdMoviesMiddleware, timeMiddleware, getMovieByIdApi)
